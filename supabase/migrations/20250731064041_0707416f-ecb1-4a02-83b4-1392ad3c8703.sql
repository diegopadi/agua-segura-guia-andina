...
DROP POLICY IF EXISTS "Anyone can create participants for active surveys" ON public.survey_participants;
DROP POLICY IF EXISTS "Allow all inserts on survey_participants" ON public.survey_participants;
...
-- Para INSERT solo necesitamos WITH CHECK, no USING
