  ...
  const etapas = [
    {
      numero: 1,
      titulo: "Diagnóstico",
      descripcion: "Exploración participativa de necesidades y oportunidades en la comunidad educativa.",
      icon: FileSearch,
      color: "#1BBEAE",
      disponible: false
    },
    {
      numero: 2,
      titulo: "Aceleración",
      descripcion: "Co-diseño de estrategias y metodologías para la investigación-acción participativa.",
      icon: Zap,
      color: "#00A6A6",
      disponible: false
    },
    {
      ...
      descripcion: "Sistematización de aprendizajes y propuesta de continuidad para CNPIE 2025.",
      icon: ClipboardCheck,
      color: "#005C6B",
      disponible: false
    }
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-base max-w-3xl" style={{ color: '#1A1A1A' }}>
            Este proyecto explora nuevas relaciones entre práctica pedagógica y participación comunitaria, 
            promoviendo la indagación colaborativa y el descubrimiento conjunto.
          </p>
        </div>
        ...
        <Alert className="mb-6 border-0" style={{ backgroundColor: '#DDF4F2' }}>
          ...
          <AlertDescription style={{ color: '#1A1A1A' }}>
            Las etapas y aceleradores específicos del Proyecto 2C se habilitarán progresivamente. 
            Cada etapa incluirá metodologías participativas y herramientas de co-diseño adaptadas a proyectos de investigación-acción.
          </AlertDescription>
        </Alert>
