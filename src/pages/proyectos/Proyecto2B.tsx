  ...
  const etapas = [
    {
      numero: 1,
      titulo: "Diagnóstico",
      descripcion: "Análisis de la situación inicial y contexto del proyecto en implementación.",
      icon: FileSearch,
      color: "#00A6A6",
      disponible: false
    },
    {
      numero: 2,
      titulo: "Aceleración",
      descripcion: "Herramientas para consolidar y fortalecer tu innovación educativa en proceso.",
      icon: Zap,
      color: "#1BBEAE",
      disponible: false
    },
    {
      ...
      descripcion: "Documentación de avances y planificación de próximos pasos para CNPIE 2025.",
      icon: ClipboardCheck,
      color: "#005C6B",
      disponible: false
    }
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-base max-w-3xl" style={{ color: '#1A1A1A' }}>
            En esta sección trabajarás las etapas de consolidación, fortalecimiento y documentación de tu proyecto en implementación.
          </p>
        </div>
        ...
        <Alert className="mb-6 border-0" style={{ backgroundColor: '#DDF4F2' }}>
          ...
          <AlertDescription style={{ color: '#1A1A1A' }}>
            Las etapas y aceleradores específicos del Proyecto 2B se habilitarán progresivamente. 
            Cada etapa incluirá herramientas de consolidación y fortalecimiento adaptadas a proyectos en implementación.
          </AlertDescription>
        </Alert>
