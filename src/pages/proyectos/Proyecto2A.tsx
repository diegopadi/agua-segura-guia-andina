  ...
  const etapas = [
    {
      ...
      titulo: "Diagnóstico",
      descripcion:
        "Lectura del diagnóstico importado y análisis de la situación actual del proyecto consolidado.",
      icon: FileSearch,
      color: "#005C6B",
      disponible: true,
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-base max-w-3xl" style={{ color: "#1A1A1A" }}>
            En esta sección trabajarás las etapas de planificación, validación y
        ...
        <Alert className="mb-6 border-0" style={{ backgroundColor: "#DDF4F2" }}>
          ...
          <AlertDescription style={{ color: "#1A1A1A" }}>
            Las etapas y aceleradores específicos del Proyecto 2A se habilitarán
            progresivamente. Cada etapa incluirá herramientas de análisis,
            validación y documentación adaptadas a proyectos consolidados.
          </AlertDescription>
        </Alert>
