...
const steps = [
  { number: 1, title: "Bienvenida", description: "Introducción al acelerador", icon: FileText },
  { number: 2, title: "Subir PEI", description: "Carga tu Proyecto Educativo Institucional", icon: Upload },
  { number: 3, title: "Formulario", description: "Responde las preguntas orientadoras", icon: Brain },
  { number: 4, title: "Análisis IA", description: "Revisión automática de completitud", icon: Brain },
  { number: 5, title: "Preguntas adicionales", description: "Completa información faltante", icon: Brain },
  { number: 6, title: "Generar reporte", description: "Descarga tu diagnóstico institucional", icon: Download }
]
